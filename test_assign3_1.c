...
testMultipleScans(void)
{
  ...
  // Mix 2 scans with c=3 as exprCond
...
void testScansTwo (void)
{
  ...
  // Select 1 record with INT in exprCond a=2.
  ...
  // Select 1 record with STRING in exprCond b='ffff'.
  ...
  // Select all records, with exprCond being false
